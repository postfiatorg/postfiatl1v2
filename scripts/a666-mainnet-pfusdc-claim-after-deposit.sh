...
capture_bin=${A666_INGRESS_CAPTURE_BIN:-/workspace/a666-acceptance/bin/eth-l1-mainnet-fast-lane-p0-cuda}
prove_bin=${A666_INGRESS_PROVE_BIN:-/workspace/a666-acceptance/bin/eth-l1-mainnet-fast-lane-p0-cuda-optimized}
route_profile_hash=${A666_ROUTE_PROFILE_HASH:-5025bdfe92669e3d8f81ce7e739fd132063261b92ef7e7ee7db19b2762e88b736bd40cd4826375e041584533f4137158}
vault_address=${A666_PFUSDC_VAULT_ADDRESS:-0xaaa78fda7062efce769e95cd72fc55e507bc8183}
...
PFTL_VAULT_ADDRESS="$vault_address" \
