...
CORPUS = ROOT.parent / "validator-identity-packets-20260904"
...
class FrozenPacketPackageTests(unittest.TestCase):
    ...
    def test_every_request_carries_exact_packet_bytes_and_hash(self) -> None:
        ...
        for row in scoring:
            ...
            self.assertNotIn(row["packet_sha256"], content)
            for banned in ("SHADOW", "uptime", "list publishers", "packet_sha256"):
    ...
    def test_prompt_defines_every_five_point_band_and_zero_rule(self) -> None:
        ...
        for banned in ("SHADOW_ONLY", "uptime", "list membership", "hash"):
