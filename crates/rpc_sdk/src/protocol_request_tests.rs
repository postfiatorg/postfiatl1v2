    ...
    fn read_response_validation_accepts_supported_results() {
                ...
                "routes": [
                    {
                        ...
                        "refund_model": "operator_attested_non_consumption",
        ...
        let navcoin_supply = success_response(
            ...
            &json!({
                ...
                "outstanding_bridge_claims_atoms": 100,
                "source_debited_export_packet_count": 1,
                "source_debited_export_packet_atoms": 100,
                "available_return_import_atoms": 20,
                "pending_return_import_claims_atoms": 30,
