...
pub use asset_orchard::{
    ...
    ASSET_ORCHARD_PRIVATE_PRIMARY_ISSUE_ACTION_SCHEMA_V1, ASSET_ORCHARD_PROOF_MAX_BYTES,
...
pub use asset_orchard_circuit::{
    build_asset_orchard_private_egress_action, build_asset_orchard_private_primary_issue_action,
    build_asset_orchard_swap_action, AssetOrchardPrivateEgressBuildResult,
    AssetOrchardPrivateEgressCircuit, AssetOrchardPrivateEgressPinnedMetadata,
    AssetOrchardPrivateEgressProvingKey, AssetOrchardPrivateEgressVerifyingKey,
    AssetOrchardPrivatePrimaryIssueBuildResult, AssetOrchardSwapBuildResult,
