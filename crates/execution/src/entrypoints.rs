...
use postfiat_types::{
    ...
    vault_bridge_bucket_id, vault_bridge_deposit_public_values_hash, vault_bridge_route_binding,
    pfusdc_source_series_id,
    ...
    FxFixReservationV1, FxFixStateV1,
    ...
    FastIngressVerifierConfigV1, VaultBridgeDepositChallengeOperation, VaultBridgeDepositClaimOperation,
    ...
    FX_FIX_PAUSE_TRANSACTION_KIND_V1, FX_FIX_REGISTER_TRANSACTION_KIND_V1,
    FX_FIX_RESERVATION_CREATE_TRANSACTION_KIND_V1,
    FX_FIX_RESERVATION_RELEASE_TRANSACTION_KIND_V1, FX_FIX_RESERVATION_STATE_ACTIVE,
    FX_FIX_RESERVATION_STATE_FILLED, FX_FIX_RESERVATION_STATE_RELEASED,
    MAX_ACTIVE_FX_FIX_RESERVATIONS_PER_FIX,
    MAX_FX_FIX_RESERVATIONS, MAX_FX_FIX_STATES,
    ...
    NAV_PROFILE_VERIFIER_SP1_GROTH16, SOURCE_PROOF_KIND_SP1_ETHEREUM_FINALITY_V1,
    ...
    MAX_YOLO_TARGET_RECEIPTS, MAX_YOLO_TARGET_REGISTRATIONS,
    ...
    vault_bridge_route_id_for_source, ETHEREUM_MAINNET_CHAIN_ID,
...
use postfiat_types::{
    ...
    VAULT_BRIDGE_ROUTE_ETHEREUM_MAINNET_USDC_V1,
    VAULT_BRIDGE_ROUTE_ETHEREUM_MAINNET_WETH_V1,
    VAULT_BRIDGE_ROUTE_ETHEREUM_SEPOLIA_USDC_V1,
};
...
pub const YOLO_TARGET_REGISTRATION_STATE_EXPANSION_FEE: u64 = 10;
pub const YOLO_TARGET_RECEIPT_STATE_EXPANSION_FEE: u64 = 10;
