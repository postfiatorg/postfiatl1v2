pub(super) use super::state_commitment_governance::*;
use super::*;
...
pub(super) fn append_ledger_state(
    ...
    if fastlane_state_present {
        ...
        if fastpay_recovery_state_present {
            let version = postfiat_types::FastPayRecoveryCommitmentVersion::for_committees(
            ...
            append_sorted_canonical_commitments(
                ...
                ledger
                    ...
                    .iter()
                    .map(|value| value.state_commitment_bytes_for_version(version)),
            )?;
            append_sorted_canonical_commitments(
                bytes,
