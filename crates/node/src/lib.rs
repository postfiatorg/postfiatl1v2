...
use postfiat_types::{
    ...
    BridgeDomain, BridgeDomainAction, BridgeDomainSpec, BridgeExitLeafV1, BridgeExitMerkleProofV1,
    ...
    VaultBridgeRedemption, VaultBridgeRouteProfileRecordV1,
    VaultBridgeWithdrawalExecutionAttestation, VaultBridgeWithdrawalExecutionObservation,
    VaultBridgeWithdrawalPacket, ADDRESS_NAMESPACE, ASSET_BURN_TRANSACTION_KIND,
    ATOMIC_SWAP_TRANSACTION_KIND, BRIDGE_DIRECTION_INBOUND, BRIDGE_DIRECTION_OUTBOUND,
    BRIDGE_EXIT_ACCEPTED_RECEIPT_CODE, DEBUG_SHIELDED_POOL_ID, DEFAULT_SHIELDED_ASSET_ID,
    ...
    NAV_PROFILE_ID_DOMAIN, NAV_PROFILE_VERIFIER_SP1_GROTH16, NAV_RESERVE_STATE_FINALIZED,
    NFT_COLLECTION_FLAG_BURN_LOCKED, NFT_COLLECTION_FLAG_TRANSFER_LOCKED, NFT_FLAG_ISSUER_BURNABLE,
    NFT_FLAG_TRANSFERABLE, NFT_ID_HEX_LEN, OFFER_ID_HEX_LEN, OFFER_OBJECT_RESERVE,
    OFFER_STATE_CANCELED, OFFER_STATE_FILLED, OFFER_STATE_OPEN, OFFER_STATE_UNFUNDED,
    OFFER_TX_ROLE_CANCEL, OFFER_TX_ROLE_MAKER, OFFER_TX_ROLE_TAKER, PAYMENT_V2_TRANSACTION_KIND,
