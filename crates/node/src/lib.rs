...
use postfiat_types::{
    ...
    Receipt, ShieldMigrateAction, ShieldedAction, ShieldedActionBatch, ShieldedDisclosure,
    ShieldedNote, ShieldedSpendResult, ShieldedState, ShieldedSwapActionPayload,
    SignedAssetTransaction, SignedAtomicSwapTransaction, SignedEscrowTransaction,
    SignedGovernanceAuthorizationV2, SignedNftTransaction, SignedOfferTransaction, SignedPaymentV2,
    SignedTransfer, SnapshotFile, SnapshotManifest, StatusReport, TransactionBatch, TrustLine,
    TrustSetOperation, TurnstileEvent, TurnstileSummary, UnsignedAssetTransaction,
    UnsignedEscrowTransaction, UnsignedNftTransaction, UnsignedOfferTransaction, UnsignedPaymentV2,
    UnsignedTransfer, ValidatorRegistryEntry, ValidatorRegistryUpdateRecord, VaultBridgeAllocation,
    VaultBridgeBucketState, VaultBridgeBurnToRedeemOperation, VaultBridgeDepositAttestOperation,
