...
struct TransportPeerCertifiedBatchRoundTimingsReport {
    ...
    certificate_ms: f64,
    legacy_certificate_ms: f64,
    consensus_v2_prepare_qc_ms: f64,
    consensus_v2_precommit_votes_ms: f64,
    consensus_v2_precommit_qc_ms: f64,
    consensus_v2_commit_assembly_ms: f64,
    consensus_v2_commit_attach_write_ms: f64,
