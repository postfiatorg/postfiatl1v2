...
fn print_usage() {
  ...
  postfiat-node vault-bridge-deposit-plan (--log-file EVM_LOG_JSON | --receipt-file EVM_RECEIPT_JSON [--vault-address ADDRESS] [--token-address ADDRESS]) --asset-id ASSET_ID --policy-hash HASH --proposer ADDRESS [--finalizer ADDRESS] [--claimer ADDRESS] [--attestor ADDRESS] --expires-at-height HEIGHT [--source-proof-kind sp1-groth16 --source-proof-hash HASH [--source-public-values-hash HASH]]
  postfiat-node vault-bridge-deposit-relay-bundle (--log-file EVM_LOG_JSON | --receipt-file EVM_RECEIPT_JSON [--vault-address ADDRESS] [--token-address ADDRESS]) --asset-id ASSET_ID --policy-hash HASH --proposer ADDRESS [--finalizer ADDRESS] [--claimer ADDRESS] [--attestor ADDRESS] --expires-at-height HEIGHT --bundle DIR [--overwrite] [--source-proof-kind sp1-groth16 --source-proof-hash HASH [--source-public-values-hash HASH]]
  postfiat-node vault-bridge-deposit-relay-rpc-bundle --source-rpc-url URL --tx-hash HASH [--cast-bin PATH] [--vault-address ADDRESS] [--token-address ADDRESS] --asset-id ASSET_ID --policy-hash HASH --proposer ADDRESS [--finalizer ADDRESS] [--claimer ADDRESS] [--attestor ADDRESS] --expires-at-height HEIGHT --bundle DIR [--overwrite] [--source-proof-kind sp1-groth16 --source-proof-hash HASH [--source-public-values-hash HASH]]
