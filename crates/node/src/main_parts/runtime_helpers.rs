...
fn print_usage() {
  ...
  postfiat-node transport-certified-send-outbox-verify [--data-dir PATH]
  ...
  postfiat-node vault-bridge-conservation-audit [--data-dir PATH] --asset-id ASSET_ID --source-rpc-url URL|CHAIN_ID=URL[,CHAIN_ID=URL] --vault-interface-lineage-manifest PATH [--cast-bin PATH]
  ...
  postfiat-node vault-bridge-deposit-plan (--log-file EVM_LOG_JSON | --receipt-file EVM_RECEIPT_JSON [--vault-address ADDRESS] [--token-address ADDRESS]) --asset-id ASSET_ID --policy-hash HASH [--route-epoch EPOCH] --proposer ADDRESS [--finalizer ADDRESS] [--claimer ADDRESS] [--attestor ADDRESS] --expires-at-height HEIGHT [--source-proof-kind KIND [--source-proof-hash HASH] [--source-public-values-hash HASH] [--source-proof-file PATH --source-public-values-file PATH]]
  postfiat-node vault-bridge-deposit-relay-bundle (--log-file EVM_LOG_JSON | --receipt-file EVM_RECEIPT_JSON [--vault-address ADDRESS] [--token-address ADDRESS]) --asset-id ASSET_ID --policy-hash HASH [--route-epoch EPOCH] --proposer ADDRESS [--finalizer ADDRESS] [--claimer ADDRESS] [--attestor ADDRESS] --expires-at-height HEIGHT --bundle DIR [--overwrite] [--source-proof-kind KIND [--source-proof-hash HASH] [--source-public-values-hash HASH] [--source-proof-file PATH --source-public-values-file PATH]]
  postfiat-node vault-bridge-deposit-relay-rpc-bundle --source-rpc-url URL --tx-hash HASH [--cast-bin PATH] [--vault-address ADDRESS] [--token-address ADDRESS] --asset-id ASSET_ID --policy-hash HASH [--route-epoch EPOCH] --proposer ADDRESS [--finalizer ADDRESS] [--claimer ADDRESS] [--attestor ADDRESS] --expires-at-height HEIGHT --bundle DIR [--overwrite] [--source-proof-kind KIND [--source-proof-hash HASH] [--source-public-values-hash HASH] [--source-proof-file PATH --source-public-values-file PATH]]
  postfiat-node pfusdc-ingress-preflight [--data-dir PATH] --asset-id ASSET_ID --recipient PFTL_ADDRESS --depositor ETHEREUM_ADDRESS --amount-atoms ATOMS
  ...
  postfiat-node ratify-orchard-aware-bridge-claim-activation-height [--data-dir PATH] --validators CSV [--support CSV] --height H [--activation-height H] [--veto-until-height H] [--paused] --amendment-file PATH
  postfiat-node ratify-pfusdc-source-series-activation-height [--data-dir PATH] --validators CSV [--support CSV] --height H [--activation-height H] [--veto-until-height H] [--paused] --amendment-file PATH
  ...
  postfiat-node operator-onboarding-keygen --validator-id NODE_ID --master-key-file PATH --validator-key-file PATH [--overwrite]
  postfiat-node operator-manifest-create --master-key-file PATH --chain-id ID --network NAME --validator-id NODE_ID --hot-public-key-hex HEX --operator NAME --contact CONTACT --provider-group NAME --region-group NAME --jurisdiction-group NAME --legal-domain-group NAME --funding-domain-group NAME [--rotation-state active|staged|retiring|suspended|removed] [--effective-height N] [--trust-graph-root HASH --trust-graph-version N --trust-view-id HASH --trust-view-version N] [--section2-packet-root HASH --source-commit HASH --release-binary-sha256 HASH --onboarding-challenge-id HASH --provider-account-fingerprint HASH --host-admin-fingerprint HASH --key-custody-fingerprint HASH --provider-attestation-hash HASH --host-control-attestation-hash HASH --custody-attestation-hash HASH] --output PATH [--overwrite]
  postfiat-node operator-manifest-verify --manifest-file PATH
  postfiat-node operator-attestation-create --master-key-file PATH --validator-id NODE_ID --onboarding-challenge-id HASH --operator NAME --observed-at RFC3339 --kind provider|host|custody [kind-specific flags] --output PATH [--overwrite]
  postfiat-node operator-attestation-verify --attestation-file PATH
  postfiat-node operator-independence-verify [--data-dir PATH] --manifest-dir PATH --attestation-dir PATH --validators CSV --quorum N --network NAME --section2-packet-root HASH --source-commit HASH --release-binary-sha256 HASH [--min-operator-groups N] [--min-infrastructure-domains N]
  ...
  postfiat-node shield-batch-asset-orchard-private-primary-issue [--data-dir PATH] --action-file PATH --batch-file PATH
