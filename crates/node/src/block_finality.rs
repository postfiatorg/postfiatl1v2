    ...
    for (asset_index, transaction) in batch.asset_transactions.iter().enumerate() {
        ...
        let (
            ...
            AssetTransactionOperation::FxFixRegisterV1(operation) => (
                ...
                operation.packet.packet_hash.clone(),
                0,
                Some(operation.packet.base_asset_id.clone()),
                None,
                None,
                None,
            ),
            AssetTransactionOperation::FxFixPauseV1(operation) => (
                operation.operator.clone(),
                operation.fix_packet_hash.clone(),
                0,
                None,
                None,
                None,
            ...
            AssetTransactionOperation::FxFixReservationCreateV1(operation) => (
                operation.operator.clone(),
                operation.action_binding_hash.clone(),
                0,
                None,
                None,
                None,
...
fn create_block_vote_for_target_with_timings(
    ...
    timings.vote_lock_files_examined = vote_lock_work.files_examined;
    timings.vote_lock_bytes_decoded = vote_lock_work.bytes_decoded;
    timings.vote_lock_migration_performed = vote_lock_work.migration_performed;
