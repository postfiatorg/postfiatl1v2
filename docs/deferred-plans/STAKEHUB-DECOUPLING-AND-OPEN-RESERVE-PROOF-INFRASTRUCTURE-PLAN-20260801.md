...
**Status:** **Deferred — incomplete and not current execution work**

**Sole authoritative Markdown:** this file is the implementation plan, current
status, continuation record, and definition of done for StakeHub deprecation.
The former handoff was merged into this file and removed; Git history retains
it. It must not be restored or maintained in parallel.
