...
- **U76 submitter.** `scripts/native_rpc_finality_submit.py` at commit `90ef0ed`, SHA-256 `36d900647da01dbe6535ec7628ce8386ed207308d0577895240c7b63f0baa3fa`, status-pins before submission and fails closed unless `ok`, `finality.confirmed`, `receipt.accepted`, and `round_ok` are true; exit 2 is STOP-no-retry.
