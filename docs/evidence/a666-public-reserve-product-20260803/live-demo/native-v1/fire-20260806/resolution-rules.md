...
- **U76 submitter.** `scripts/native_rpc_finality_submit.py` at commit `90ef0ed`, SHA-256 `fed5225f4436234ad169955a8880158598a3cebb53e110ac3d1f7fddb3bfbc72`, status-pins before submission and fails closed unless `ok`, `finality.confirmed`, `receipt.accepted`, and `round_ok` are true; exit 2 is STOP-no-retry.
