...
**Status:** A1, A2, A3, and A4 done with the review limits below; A5 and B pending. No live activation or fleet action.
...
Current finding totals: **0 P1, 8 P2, 4 P3** (A1, A2, A3, and A4).
