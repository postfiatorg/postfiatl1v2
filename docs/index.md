...
| Storage scaling | An undeployed transactional candidate passes snapshot/rebuild equality, exact height-915 replay, the closed 69-case tamper/crash matrix, and compatible two-binary rollback. Exact height 924, paired six-validator performance, six-clone migration, and final packet gates remain open; public testnet is blocked. | [Active milestone](plans/active/storage-scaling-milestone.md), [State and Storage](architecture/state-and-storage.md) |
