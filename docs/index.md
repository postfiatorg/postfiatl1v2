...
drills; Consensus v2 remained the only block-finality protocol.
...
| Storage scaling | An undeployed transactional candidate passes snapshot/rebuild equality, exact height-915 replay, the closed 69-case tamper/crash matrix, compatible two-binary rollback, and a development-only height-501 six-clone migration rehearsal. Exact height 924, clean-source migration qualification, paired six-validator performance, and final packet gates remain open; public testnet is blocked. | [Active milestone](plans/active/storage-scaling-milestone.md), [State and Storage](architecture/state-and-storage.md) |
...
| Cobalt governance | The E1-E6 campaign closed `KEEP_ACTIVE` for validator-trust evolution only; Cobalt does not choose trust, originate proposals, or control block finality. | [Adversarial Results](governance/cobalt-adversarial-verification-results.md), [Cobalt Governance](governance/cobalt.md) |
