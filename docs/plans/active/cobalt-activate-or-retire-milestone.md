...
- Simulation-only task: `[x] task_043e009b196aea0b685b3f09a6ebb45d — accepted; execution packet passes, Task Node verification pending`. Its acceptance contract is simulation-only: one controller may orchestrate every isolated validator domain. It must not require separate operators, provider accounts, machines, administrators, or custody boundaries.
