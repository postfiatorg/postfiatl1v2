...
- [x] Replace quadratic DABC proof duplication with canonical compact encoding and cap the complete certificate at 1 MiB; verify the resulting update through the real live signed-governance-batch path. The six-validator compact certificate is 511,502 bytes minified, 217,385 bytes / 29.82% smaller than the equivalent expanded certificate. Code commit: `cf5a89334aee8f53a74eab4201b924b9d24bc674`. Packet: [`packet-authoritative-v3`](../../../benchmarks/cobalt-handoff-rehearsal/packet-authoritative-v3), `SHA256SUMS` root `b58549b9cd2db978b7708aac0d6f753c166043c6b102e699edfdb73a3cfc692a`.
...
- [x] Freeze the six-slot self-custody onboarding contract, exact release hash, unique challenges, current trust views, and static verifier. Packet: [`benchmarks/cobalt-independent-operators`](../../../benchmarks/cobalt-independent-operators), `SHA256SUMS.txt` root `40ff699733b3c0c7685982360d5c535e3e8b37d19504f60f438bd52b9a45809e`.
- [x] Bind each operator's signed manifest to the Cobalt trust view, Section 2 packet root, source commit, release-binary SHA-256, onboarding challenge, infrastructure-account fingerprint, host administrator, and ML-DSA custody evidence. Code: [`consensus_artifacts.rs`](../../../crates/node/src/consensus_artifacts.rs), [`operator-manifest-create`](../../../crates/node/src/main_parts/cli_dispatch_parts/group_04.rs).
