...
| Packet-based identity replay | The legitimacy score run from exact packet bytes instead of an entity-name mapping | [192/192 byte-identical](identity-packet-replay-results-20260903.md#determinism-proof) across two distinct-owner hosts and four runs; 22/55 recognized, 33/55 zero, versus the packets' descriptive 45 established-or-likely / 10 not-established split; every PostFiat validator scored 0; total spend $4.82646976999831 | [`benchmarks/ai-governance/identity-packet-replay-20260903/`](https://github.com/postfiatorg/postfiatl1v2/blob/main/benchmarks/ai-governance/identity-packet-replay-20260903/README.md) |
