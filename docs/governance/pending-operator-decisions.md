...
| Institution-legitimacy score for provider claims | Use `qwen/qwen3.8-27b` to score whether the named institution is recognizable and legitimate; an institution the model does not recognize receives 0. Do not replace this judgment with deterministic validator sub-scorer formulas. | [Institution legitimacy scoring](institution-legitimacy-scoring.md); operator clarification on 2026-09-01 | **Confirmed:** AI scores institutional legitimacy; unrecognized means 0. |
