...
| 20 | Topology/independence thresholds | Placement preflight and concentration caps are defined for launch. | OPEN | milestone [D3 unchecked](../plans/active/l1v2-public-testnet-path-milestone.md); [public launch boundary](../security/public-launch-boundary.md) (mechanics may be green "before public operator diversity exists") | D3 |
