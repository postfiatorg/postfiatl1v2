...
Date: 2026-07-16
Report: `docs/status/OPEN-SOURCE-RPC-AUTHORIZATION-INVENTORY-20260716.json`
...
- Total methods observed: 135
- Read-only public methods: 63
- Public cryptographically authorized protocol mutations: 12
- Controlled write gated methods: 14
- Privacy-alpha gated methods: 4
- Owned-lane gated methods: 4
