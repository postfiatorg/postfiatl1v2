...
pub(crate) fn ntt<const KL: usize>(w: &[R; KL]) -> [T; KL] {
    crate::cycle_tracking::write(b"cycle-tracker-report-start:mldsa.ntt.forward\n");
    ...
    // 20: return ŵ
    crate::cycle_tracking::write(b"cycle-tracker-report-end:mldsa.ntt.forward\n");
    w_hat
}
...
pub(crate) fn inv_ntt<const KL: usize>(w_hat: &[T; KL]) -> [R; KL] {
    crate::cycle_tracking::write(b"cycle-tracker-report-start:mldsa.ntt.inverse\n");
    //
    ...
    // 25: return w
    crate::cycle_tracking::write(b"cycle-tracker-report-end:mldsa.ntt.inverse\n");
    w_out
}
