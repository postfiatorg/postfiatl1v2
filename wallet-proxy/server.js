...
const WALLET_CSP = "default-src 'self'; base-uri 'none'; frame-ancestors 'none'; form-action 'self'; script-src 'self' 'wasm-unsafe-eval'; object-src 'none'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; connect-src 'self' wss: ws://127.0.0.1:8080 ws://localhost:8080 http://127.0.0.1:8789 http://localhost:8789;";
...
function websocketOriginAllowed(req) {
    ...
    // Reverse proxies retain the browser-facing Host (or provide
    // X-Forwarded-Host). Accept that exact same origin so SSH tunnels and
    // localhost aliases do not require an ever-growing static allowlist.
    // A different host remains forbidden.
...
const walletProxyRuntime = { A651_ASSET_ID,
A652_ASSET_ID,
ALLOWED_ORIGINS,
...
boundedHttpBodyLimit,
crypto,
execFileAsync,
fastpayCertificateOutbox,
fastpayFleetStatusCache,
fastpayFleetStatusInFlight,
fs,
http,
httpMutationAuthorized,
...
requestWithProxyReadiness: requestWithProxyReadinessBase,
resolveRpcTarget,
responseEnvelope,
rpcTcpRequest,
rpcTcpRequestLine,
...
walletSnapshotDigest } = walletProxyRuntime;
...
const { assetIdForNavswapSymbol,
buildNavswapQuoteResponse,
buildPftlUniswapReceiptVerification,
buildTransparentNavswapReceiptVerification,
buildTransparentNavswapRedeemReceiptVerification,
buildUrl,
completePftlUniswapHandoffRun,
completeTransparentNavswapRun,
executeNavswapDevnetPfusdcFunding,
executeNavswapQuote,
executePftlUniswapHandoffRun,
executePftlUniswapWalletQuote,
executeTransparentNavswapQuote,
executeTransparentNavswapReadiness,
executeTransparentNavswapRun,
fetchJsonWithTimeout,
isIssuedAsset,
isPftAsset,
loadPftlUniswapWalletActionContext,
navswapAccountAssetItems,
navswapAccountBalanceAtoms,
navswapActionAutoPlanRequested,
navswapActionPrepareError,
navswapAllocationRemainingAtoms,
navswapAssetInfoAsset,
navswapAssetInfoIssuer,
navswapAssetIssuer,
navswapAssetPrecision,
navswapCompletionConsumerIds,
navswapCompletionOperationTemplate,
navswapCompletionSubmittedChainId,
navswapCompletionSubmittedSequence,
navswapConsumerMatchesRecipient,
navswapDecimalAmountToAtoms,
navswapFreshnessFromBody,
navswapFreshnessPayload,
navswapHashHexDomain,
navswapNativeAccountBalanceAtoms,
navswapNavRedemptionId,
navswapPftlUniswapControlledAttestationTxHash,
navswapPftlUniswapDefaultDeadlineSeconds,
navswapPftlUniswapDefaultEthereumRecipient,
navswapPftlUniswapDefaultRefundDelayBlocks,
navswapPftlUniswapDestinationHeights,
navswapPftlUniswapPacketHash,
navswapPftlUniswapRouteRow,
navswapPlannerCurrentHeight,
navswapPlannerError,
navswapPlannerNumber,
navswapPlannerPositiveNumber,
navswapPlannerRemainingAtoms,
navswapPrimaryMintIntentFields,
navswapProofIsFresh,
navswapRandomHex,
navswapReceiptFreshness,
navswapRedeemCompletionOperationTemplate,
navswapRequiredVaultBridgeSettlementAtoms,
navswapRouteFromBody,
navswapRpcRead,
navswapSafeU64Number,
navswapSettlementReceiptFreshnessConfig,
navswapSettlementReceiptHash,
navswapSubscriptionId,
navswapValuationUnitScale,
navswapWalletActionBatchItems,
navswapWalletActionId,
normalizePftlUniswapPacketStatus,
parseAtomicInteger,
parseNavswapActionInteger,
parseNavswapDisplayOrAtomAmount,
parseNavswapEvmAddress,
parseNavswapHexId,
parseNavswapWalletAddress,
pftlUniswapCompletionError,
pftlUniswapCompletionQuote,
pftlUniswapPreparedAction,
planTransparentNavswapWalletActions,
preflightNavswapPreparedActionFees,
prepareNavswapWalletAction,
prepareNavswapWalletActionBatch,
prepareNavswapWalletNavRedeemAtNavAction,
prepareNavswapWalletNavSubscriptionAllocateAction,
preparePftlUniswapWalletActionBatch,
selectNavswapIssuedSettlementSource,
selectTransparentRedeemSettlementAllocation,
signAndSubmitNavswapOperatorAssetTransaction,
transparentCompletionError,
transparentCompletionPreparedAction,
transparentCompletionQuote,
transparentCompletionStage,
transparentCompletionSubmission,
transparentCompletionWalletResult,
validateNavswapPlannerMarketStatus,
verifyPftlUniswapExportPacket,
verifyPftlUniswapWalletCompletionInput,
verifyTransparentNavRedeemSettlement,
verifyTransparentNavSubscriptionAllocation,
verifyTransparentWalletCompletionInput } = walletProxyRuntime;
Object.assign(walletProxyRuntime, atomicNavswapModule.create(walletProxyRuntime));
const { atomicRpcProxyError,
executeAtomicNavswapQuote,
executeAtomicNavswapRun,
executeNavswapCapabilitiesWithAtomic,
executeNavswapQuoteWithAtomic,
executeTransparentNavswapRunWithAtomic } = walletProxyRuntime;
...
certifiedRoundFailure,
certifiedRoundHasQuorumCertificate,
certifiedRoundHeight,
certifiedRoundReceipts,
certifyShieldedBatchViaWarmLoop,
chooseShieldedCatchUpSource,
cloneJson,
collectShieldedTopologyStatuses,
createShieldedSwapBatchViaLocalService,
executeShieldedNavswapBalances,
executeShieldedNavswapEgress,
executeShieldedNavswapIngress,
executeShieldedNavswapIngressPreflight,
executeShieldedNavswapNoteCapability,
executeShieldedNavswapProverReadiness,
executeShieldedNavswapQuote,
executeShieldedNavswapStatus,
executeShieldedNavswapSwap,
fileMtimeUnixMs,
findAssetOrchardActionCleartext,
loadShieldedTopologyPeers,
majorityRootAtHeight,
maxMtimeUnixMs,
msSpan,
navswapIdempotencyKeyFromRequest,
navswapIdempotencyStorePath,
navswapRunStorePath,
navswapStableJson,
navswapValidateIdempotencyKey,
newNavswapRunId,
parseShieldedPrivateEgressJson,
parseShieldedSwapActionJson,
runShieldedLaggardCatchUp,
runShieldedRpcCatchUp,
shellQuote,
shieldedBatchExplicitActionIds,
shieldedCatchUpLaggards,
shieldedCatchUpSourceCandidates,
shieldedCertifiedRoundEnv,
shieldedCertifierLoopBatchFile,
shieldedCertifierLoopStartHeight,
shieldedCertifierLoopState,
shieldedConvergenceSummary,
shieldedEarlyQuorumEnabled,
shieldedIngressSupportedAsset,
shieldedLaggardCatchUpConfig,
shieldedPrivateEgressDisclosureFields,
shieldedPrivateEgressDisclosureHash,
shieldedQuoteAssetByInput,
shieldedQuoteFromSubmitBody,
shieldedQuotePairEnabled,
shieldedRemoteDataDir,
shieldedRemoteWorkDir,
shieldedRoundBatchIds,
shieldedRoundPhaseTimings,
shieldedRoundReceiptIds,
shieldedSwapProxyTimingReport,
startShieldedCertifierLoop,
validateShieldedCertifierLoopReportForBatch,
validateShieldedEgressSubmit,
validateShieldedIngressPayload,
validateShieldedPrivateEgressFile,
validateShieldedSwapAction,
validateShieldedSwapSubmit } = walletProxyRuntime;
...
if (require.main === module) {
    ...
    const shutdown = (signal) => {
        ...
        try { walletProxyRuntime.closeNavcoinExportRelayJobs?.(); } catch (_) { /* best effort */ }
        try { walletProxyRuntime.closeNavcoinReturnRelayJobs?.(); } catch (_) { /* best effort */ }
