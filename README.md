...
| Storage scaling | Current source contains an undeployed bounded JSONL-tail and ordered-history candidate with synthetic fixed-work evidence through height 5,000. The required six-validator finality, replay, tamper, migration, CLI, and browser gates remain open; public testnet is blocked. See the [active milestone](docs/plans/active/storage-scaling-milestone.md). |
